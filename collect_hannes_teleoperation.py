...
# Whether to enable sticky-hand logic (auto attaching objects to hand on contact)
ENABLE_STICKY_HAND = False
...
env = suite.make(
    ...
    use_camera_obs=True,
    camera_names=["sideview", "agentview"],
    camera_heights=512,
    camera_widths=512,
    control_freq=20,
    horizon=1000,
...
with h5py.File(save_path, 'w') as f:
    for ep in range(NUM_EPISODES):
        ...
        while not state.esc_pressed:
            ...
            if ENABLE_STICKY_HAND and _STICKY_OBJECTS and _STICKY_PALM_SITE_ID is not None:
        ...
        sideview_path = os.path.join(video_dir, f'{timestamp}_ep{ep}_sideview.mp4')
        ...
        print(f"  Videos saved: {sideview_path}")
